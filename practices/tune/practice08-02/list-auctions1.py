...
headers0= \
  [ NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
    NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/ListServlet;jsessionid=pJ1_ARKuTkLdf3CUjA9QdC7loA3mDcZIJDh85BNRiyTRD8vORvYy!-406544328'), ]

headers1= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/'), ]

headers2= \
  [ NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
    NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/ListServlet'), ]
...
class TestRunner:
  ...
  def page2(self):
    ...
    result = request201.GET('/SimpleAuctionWebAppDb1/res/styles.css;jsessionid=' +
      ...
      ( NVPair('Accept', 'text/css,*/*;q=0.1'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/index.jsp'), ))
  ...
  def page13(self):
    ...
    result = request1301.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      ...
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/DetailServlet?id=1'), ))
  ...
  def page25(self):
    ...
    result = request2501.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      ...
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/DetailServlet?id=2'), ))
  ...
  def page37(self):
    ...
    result = request3701.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      ...
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/DetailServlet?id=3'), ))
  ...
  def page49(self):
    ...
    result = request4901.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      ...
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb1/DetailServlet?id=4'), ))
