# The Grinder 3.11
# HTTP script recorded by TCPProxy at Oct 17, 2014 8:04:15 AM
...
headers1= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/'), ]

headers2= \
  [ NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
    NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/ListServlet;jsessionid=MiQerDnAC3Ltf4UWRmhk2OMkgtTqKyIKZVfp1LwAFedjLWBBzMP2!-850280571'), ]

headers3= \
  [ NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
    NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/ListServlet'), ]

url0 = 'http://host01:7777'

request101 = createRequest(Test(101, 'GET SimpleAuctionWebAppDb'), url0, headers0)

request102 = createRequest(Test(102, 'GET /'), url0, headers0)

request201 = createRequest(Test(201, 'GET styles.css'), url0)

request202 = createRequest(Test(202, 'GET favicon.ico'), url0)

request203 = createRequest(Test(203, 'GET favicon.ico'), url0, headers0)

request301 = createRequest(Test(301, 'GET ListServlet'), url0, headers1)

request302 = createRequest(Test(302, 'GET styles.css'), url0)

request401 = createRequest(Test(401, 'GET AuctionImageServlet'), url0, headers2)

request501 = createRequest(Test(501, 'GET AuctionImageServlet'), url0, headers2)

request601 = createRequest(Test(601, 'GET AuctionImageServlet'), url0, headers2)

request701 = createRequest(Test(701, 'GET AuctionImageServlet'), url0, headers2)

request801 = createRequest(Test(801, 'GET AuctionImageServlet'), url0, headers2)

request901 = createRequest(Test(901, 'GET AuctionImageServlet'), url0, headers2)

request1001 = createRequest(Test(1001, 'GET AuctionImageServlet'), url0, headers2)

request1101 = createRequest(Test(1101, 'GET AuctionImageServlet'), url0, headers2)
...
request1501 = createRequest(Test(1501, 'GET createAuction.jsp'), url0, headers1)

request1601 = createRequest(Test(1601, 'GET ListServlet'), url0)

request1701 = createRequest(Test(1701, 'GET AuctionImageServlet'), url0, headers3)

request1801 = createRequest(Test(1801, 'GET AuctionImageServlet'), url0, headers3)

request1901 = createRequest(Test(1901, 'GET AuctionImageServlet'), url0, headers3)

request2001 = createRequest(Test(2001, 'GET AuctionImageServlet'), url0, headers3)

request2101 = createRequest(Test(2101, 'GET AuctionImageServlet'), url0, headers3)

request2201 = createRequest(Test(2201, 'GET AuctionImageServlet'), url0, headers3)

request2301 = createRequest(Test(2301, 'GET AuctionImageServlet'), url0, headers3)

request2401 = createRequest(Test(2401, 'GET AuctionImageServlet'), url0, headers3)

request2501 = createRequest(Test(2501, 'GET DetailServlet'), url0)

request2601 = createRequest(Test(2601, 'GET AuctionImageServlet'), url0)

request2701 = createRequest(Test(2701, 'GET /'), url0)

request2801 = createRequest(Test(2801, 'GET ListServlet'), url0, headers1)

request2901 = createRequest(Test(2901, 'GET AuctionImageServlet'), url0, headers3)

request3001 = createRequest(Test(3001, 'GET AuctionImageServlet'), url0, headers3)

request3101 = createRequest(Test(3101, 'GET AuctionImageServlet'), url0, headers3)

request3201 = createRequest(Test(3201, 'GET AuctionImageServlet'), url0, headers3)

request3301 = createRequest(Test(3301, 'GET AuctionImageServlet'), url0, headers3)

request3401 = createRequest(Test(3401, 'GET AuctionImageServlet'), url0, headers3)

request3501 = createRequest(Test(3501, 'GET AuctionImageServlet'), url0, headers3)

request3601 = createRequest(Test(3601, 'GET AuctionImageServlet'), url0, headers3)
...
class TestRunner:
  ...
  def page1(self):
    """GET SimpleAuctionWebAppDb (requests 101-102)."""
    
    # Expecting 302 'Moved Temporarily'
    result = request101.GET('/SimpleAuctionWebAppDb')

    grinder.sleep(91)
    request102.GET('/SimpleAuctionWebAppDb/')
    self.token_jsessionid = \
      httpUtilities.valueFromBodyURI('jsessionid') # 'MiQerDnAC3Ltf4UWRmhk2OMkgtTqKyIKZVfp1LwA...'

    return result

  def page2(self):
    """GET styles.css (requests 201-203)."""
    result = request201.GET('/SimpleAuctionWebAppDb/res/styles.css;jsessionid=' +
      self.token_jsessionid, None,
      ( NVPair('Accept', 'text/css,*/*;q=0.1'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/'), ))

    grinder.sleep(27)
    request202.GET('/favicon.ico', None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'), ))

    request203.GET('/favicon.ico')

    return result

  def page3(self):
    """GET ListServlet (requests 301-302)."""
    result = request301.GET('/SimpleAuctionWebAppDb/ListServlet;jsessionid=' +
      self.token_jsessionid)
    ...
    grinder.sleep(74)
    request302.GET('/SimpleAuctionWebAppDb/res/styles.css', None,
      ( NVPair('Accept', 'text/css,*/*;q=0.1'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/ListServlet;jsessionid=MiQerDnAC3Ltf4UWRmhk2OMkgtTqKyIKZVfp1LwAFedjLWBBzMP2!-850280571'), ))
  ...
  def page4(self):
    ...
    self.token_mode = \
      'thumb'
    result = request401.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page5(self):
    ...
    self.token_imageId = \
      '1'
    result = request501.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page6(self):
    ...
    self.token_imageId = \
      '3'
    result = request601.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page7(self):
    ...
    self.token_imageId = \
      '4'
    result = request701.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page12(self):
    ...
    self.token_id = \
      '3'
    result = request1201.GET('/SimpleAuctionWebAppDb/DetailServlet' +
      '?id=' +
      self.token_id, None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/ListServlet;jsessionid=MiQerDnAC3Ltf4UWRmhk2OMkgtTqKyIKZVfp1LwAFedjLWBBzMP2!-850280571'), ))
  ...
  def page13(self):
    ...
    result = request1301.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      ...
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/DetailServlet?id=3'), ))

    return result

  def page14(self):
    """GET / (request 1401)."""
    result = request1401.GET('/SimpleAuctionWebAppDb/', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/DetailServlet?id=3'), ))
  ...
  def page15(self):
    """GET createAuction.jsp (request 1501)."""
    result = request1501.GET('/SimpleAuctionWebAppDb/createAuction.jsp')

    return result

  def page16(self):
    """GET ListServlet (request 1601)."""
    result = request1601.GET('/SimpleAuctionWebAppDb/ListServlet', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/createAuction.jsp'), ))
    # 8 different values for token_id found in response, using the first one.
    self.token_id = \
      httpUtilities.valueFromBodyURI('id') # '1'
  ...
  def page18(self):
    ...
    self.token_imageId = \
      '1'
    result = request1801.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page25(self):
    """GET DetailServlet (request 2501)."""
    result = request2501.GET('/SimpleAuctionWebAppDb/DetailServlet' +
      '?id=' +
      self.token_id, None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/ListServlet'), ))
  ...
  def page26(self):
    ...
    result = request2601.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      ...
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/DetailServlet?id=1'), ))

    return result

  def page27(self):
    """GET / (request 2701)."""
    result = request2701.GET('/SimpleAuctionWebAppDb/', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7777/SimpleAuctionWebAppDb/DetailServlet?id=1'), ))
  ...
  def page28(self):
    """GET ListServlet (request 2801)."""
    result = request2801.GET('/SimpleAuctionWebAppDb/ListServlet')
  ...
  def page29(self):
    ...
    self.token_imageId = \
      '0'
    result = request2901.GET('/SimpleAuctionWebAppDb/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def __call__(self):
    ...
    self.page1()      # GET SimpleAuctionWebAppDb (requests 101-102)

    grinder.sleep(50)
    self.page2()      # GET styles.css (requests 201-203)

    grinder.sleep(4893)
    self.page3()      # GET ListServlet (requests 301-302)
    ...
    grinder.sleep(2345)
    self.page15()     # GET createAuction.jsp (request 1501)

    grinder.sleep(1585)
    self.page16()     # GET ListServlet (request 1601)
    ...
    grinder.sleep(698)
    self.page25()     # GET DetailServlet (request 2501)
    self.page26()     # GET AuctionImageServlet (request 2601)

    grinder.sleep(2618)
    self.page27()     # GET / (request 2701)

    grinder.sleep(1619)
    self.page28()     # GET ListServlet (request 2801)
