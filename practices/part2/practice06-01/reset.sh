...
#Remove all scripts from main practice folder (solutions are preserved in solution folder)
rm -f *.py

#Remove student created domain and template
rm -f SimpleDomainManaged.jar
