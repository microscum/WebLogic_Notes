...
#Do solution work before starting server1
echo "Configuring solution..."
#Create work managers
java weblogic.WLST $practice/solution/createWorkManager1.py
java weblogic.WLST $practice/solution/createWorkManager2.py

#Deploy applications using plans that associate work managers with each application
$practice/redeploy.sh
