...
headers0= \
  [ NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
    NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/ListServlet;jsessionid=pJ1_ARKuTkLdf3CUjA9QdC7loA3mDcZIJDh85BNRiyTRD8vORvYy!-406544328'), ]

headers1= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/'), ]

headers2= \
  [ NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
    NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/ListServlet'), ]
...
class TestRunner:
  ...
  def page1(self):
    ...
    result = request101.GET('/SimpleAuctionWebAppDb1/index.jsp', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'), ))
  ...
  def page2(self):
    ...
    result = request201.GET('/SimpleAuctionWebAppDb1/res/styles.css;jsessionid=' +
      self.token_jsessionid, None,
      ( NVPair('Accept', 'text/css,*/*;q=0.1'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/index.jsp'), ))

    return result

  def page3(self):
    """GET ListServlet (request 301)."""
    result = request301.GET('/SimpleAuctionWebAppDb1/ListServlet;jsessionid=' +
      self.token_jsessionid, None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/index.jsp'), ))
  ...
  def page4(self):
    ...
    self.token_mode = \
      'thumb'
    result = request401.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page5(self):
    ...
    self.token_imageId = \
      '2'
    result = request501.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page6(self):
    ...
    self.token_imageId = \
      '3'
    result = request601.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page7(self):
    ...
    self.token_imageId = \
      '6'
    result = request701.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page8(self):
    ...
    self.token_imageId = \
      '7'
    result = request801.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page9(self):
    ...
    self.token_imageId = \
      '0'
    result = request901.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page10(self):
    ...
    self.token_imageId = \
      '5'
    result = request1001.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page11(self):
    ...
    self.token_imageId = \
      '4'
    result = request1101.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page12(self):
    ...
    result = request1201.GET('/SimpleAuctionWebAppDb1/DetailServlet' +
      '?id=' +
      self.token_id, None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/ListServlet;jsessionid=pJ1_ARKuTkLdf3CUjA9QdC7loA3mDcZIJDh85BNRiyTRD8vORvYy!-406544328'), ))
  ...
  def page13(self):
    ...
    self.token_imageId = \
      '1'
    result = request1301.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=1'), ))

    return result

  def page14(self):
    """GET / (request 1401)."""
    result = request1401.GET('/SimpleAuctionWebAppDb1/', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=1'), ))
  ...
  def page15(self):
    ...
    result = request1501.GET('/SimpleAuctionWebAppDb1/ListServlet')
  ...
  def page16(self):
    ...
    self.token_imageId = \
      '0'
    result = request1601.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page17(self):
    ...
    self.token_imageId = \
      '2'
    result = request1701.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page18(self):
    ...
    result = request1801.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page19(self):
    ...
    self.token_imageId = \
      '6'
    result = request1901.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page20(self):
    ...
    self.token_imageId = \
      '7'
    result = request2001.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page21(self):
    ...
    self.token_imageId = \
      '5'
    result = request2101.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page22(self):
    ...
    self.token_imageId = \
      '4'
    result = request2201.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page23(self):
    ...
    self.token_imageId = \
      '3'
    result = request2301.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page24(self):
    ...
    self.token_id = \
      '2'
    result = request2401.GET('/SimpleAuctionWebAppDb1/DetailServlet' +
      '?id=' +
      self.token_id)
  ...
  def page25(self):
    ...
    self.token_imageId = \
      '2'
    result = request2501.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=2'), ))

    return result

  def page26(self):
    """GET / (request 2601)."""
    result = request2601.GET('/SimpleAuctionWebAppDb1/', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=2'), ))
  ...
  def page27(self):
    ...
    result = request2701.GET('/SimpleAuctionWebAppDb1/ListServlet')
    # 8 different values for token_id found in response, using the first one.
    self.token_id = \
      httpUtilities.valueFromBodyURI('id') # '1'
  ...
  def page28(self):
    ...
    result = request2801.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page29(self):
    ...
    self.token_imageId = \
      '1'
    result = request2901.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page30(self):
    ...
    self.token_imageId = \
      '3'
    result = request3001.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page31(self):
    ...
    self.token_imageId = \
      '5'
    result = request3101.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page32(self):
    ...
    self.token_imageId = \
      '4'
    result = request3201.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page33(self):
    ...
    self.token_imageId = \
      '6'
    result = request3301.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page34(self):
    ...
    self.token_imageId = \
      '7'
    result = request3401.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page35(self):
    ...
    self.token_imageId = \
      '0'
    result = request3501.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page36(self):
    ...
    self.token_id = \
      '3'
    result = request3601.GET('/SimpleAuctionWebAppDb1/DetailServlet' +
      '?id=' +
      self.token_id)
  ...
  def page37(self):
    ...
    self.token_imageId = \
      '3'
    result = request3701.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=3'), ))

    return result

  def page38(self):
    """GET / (request 3801)."""
    result = request3801.GET('/SimpleAuctionWebAppDb1/', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=3'), ))
  ...
  def page39(self):
    ...
    result = request3901.GET('/SimpleAuctionWebAppDb1/ListServlet')
    # 8 different values for token_id found in response, using the first one.
    self.token_id = \
      httpUtilities.valueFromBodyURI('id') # '1'
  ...
  def page40(self):
    ...
    result = request4001.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page41(self):
    ...
    self.token_imageId = \
      '0'
    result = request4101.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page42(self):
    ...
    self.token_imageId = \
      '4'
    result = request4201.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page43(self):
    ...
    self.token_imageId = \
      '1'
    result = request4301.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page44(self):
    ...
    self.token_imageId = \
      '2'
    result = request4401.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page45(self):
    ...
    self.token_imageId = \
      '5'
    result = request4501.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page46(self):
    ...
    self.token_imageId = \
      '7'
    result = request4601.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page47(self):
    ...
    self.token_imageId = \
      '6'
    result = request4701.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId +
      '&mode=' +
      self.token_mode)
  ...
  def page48(self):
    ...
    self.token_id = \
      '4'
    result = request4801.GET('/SimpleAuctionWebAppDb1/DetailServlet' +
      '?id=' +
      self.token_id)
  ...
  def page49(self):
    ...
    self.token_imageId = \
      '4'
    result = request4901.GET('/SimpleAuctionWebAppDb1/AuctionImageServlet' +
      '?imageId=' +
      self.token_imageId, None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=4'), ))

    return result

  def page50(self):
    """GET / (request 5001)."""
    result = request5001.GET('/SimpleAuctionWebAppDb1/', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://host01:7011/SimpleAuctionWebAppDb1/DetailServlet?id=4'), ))
