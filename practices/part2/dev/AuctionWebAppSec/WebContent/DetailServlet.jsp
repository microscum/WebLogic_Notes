    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>$<fmt:formatNumber value="${auction.currPrice + auction.bidIncrement}" pattern="#.##"/></td>
        </tr>
      </tbody>
    </table>
    ...
    <form action="${bidSvltURL}" method="POST">
      <table>
        <tr>
          <td>Your bid:</td>
          <td>
            <fmt:formatNumber value="${auction.currPrice + auction.bidIncrement}" pattern="#.##" var="suggestedPrice"/>
            $
