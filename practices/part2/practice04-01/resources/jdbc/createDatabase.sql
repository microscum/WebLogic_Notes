...
/*
create trigger imageid_trigger
before insert on Image
for each row
begin
select imageid_sequence.nextval into :new.ImageID from dual;
end;
/

create trigger auctionid_trigger
before insert on Auction
for each row
begin
select auctionid_sequence.nextval into :new.AuctionID from dual;
end;
/

create trigger bidid_trigger
before insert on Bid
for each row
begin
select bidid_sequence.nextval into :new.BidID from dual;
end;
/
*/
quit;
