...
@MessageDriven(
		activationConfig = {
				...
				@ActivationConfigProperty(
						propertyName = "destinationJndiName", propertyValue = "jms.example.Queue1"),
				@ActivationConfigProperty(
						propertyName = "connectionFactoryJndiName", propertyValue = "jms.example.Factory1"),
				@ActivationConfigProperty(
						propertyName = "providerURL", propertyValue = "t3://host01:7011"),
		}
)
public class BasicQueueConsumerBean1 implements MessageListener {

	protected FileWriter writer;
	
    public BasicQueueConsumerBean1() {
    }
    ...
    public void onMessage(Message message) {
    	...
    	try {
        	writer = new FileWriter("BasicQueueConsumerBean1.log",true);
