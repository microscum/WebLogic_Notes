...
@MessageDriven(
		activationConfig = {
				...
				@ActivationConfigProperty(
						propertyName = "destinationJndiName", propertyValue = "jms.example.Topic1"),
				@ActivationConfigProperty(
				...
				@ActivationConfigProperty(
						propertyName = "topicMessagesDistributionMode", propertyValue = "One-Copy-Per-Application"),
		}
)
public class BasicTopicConsumerBean2 implements MessageListener {

	protected FileWriter writer;
	
    public BasicTopicConsumerBean2() {
    }
    ...
    public void onMessage(Message message) {
        ...
        try {
        	writer = new FileWriter("BasicTopicConsumerBean2.log",true);
