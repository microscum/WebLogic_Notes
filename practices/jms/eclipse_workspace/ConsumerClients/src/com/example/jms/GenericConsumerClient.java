...
public class GenericConsumerClient {

	public static void main(String[] args) throws Exception {
		if (args.length != 6) {
			System.out
					.println("Usage: GenericConsumerClient name url factory dest autoAck sleepTime");
			return;
		}
		String name = args[0];
		String url = args[1];
		...
		if (isQueue) {
			BasicQueueReceiver receiver = new BasicQueueReceiver(name, url,
