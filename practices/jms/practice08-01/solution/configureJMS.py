...
serverName2 = 'server2'
serverName3 = 'server3'
mtName1 = serverName1 + ' (migratable)'
mtName2 = serverName2 + ' (migratable)'
mtName3 = serverName3 + ' (migratable)'
...
# Save references to migratable targets
mt1 = getMBean('/MigratableTargets/' + mtName1)
mt2 = getMBean('/MigratableTargets/' + mtName2)
mt3 = getMBean('/MigratableTargets/' + mtName3)
